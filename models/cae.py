...
class CAE(nn.Module):
    ...
    def __init__(self):
        ...
        self.up_conv3 = nn.ConvTranspose2d(128, 64, 3, stride=2)
        self.up_bn3 = nn.BatchNorm2d(64)
        self.up_conv4 = nn.ConvTranspose2d(64, 32, 4, stride=2)
        self.up_bn4 = nn.BatchNorm2d(32)
        self.mix_conv = nn.Conv2d(32, 3, 3, stride=1, padding=1)
